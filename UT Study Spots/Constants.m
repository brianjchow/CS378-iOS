...
+ (void) load {
//    NSArray *const DAYS_OF_WEEK_SHORT = [[NSArray alloc] initWithObjects : @"", @"SUN", @"MON", @"TUE", @"WED", @"THU", @"FRI", @"SAT"];
    ...
    if (!done) {
        ...
        DAYBREAK = [Utilities get_date : 1 day : 2 year : 2015 hour : LAST_HOUR_OF_DAY minute : LAST_MINUTE_OF_DAY localise : false];
        NIGHTFALL = [Utilities get_date : 1 day : 1 year : 2015 hour : LAST_HOUR_OF_NIGHT minute : LAST_MINUTE_OF_NIGHT localise : false];
